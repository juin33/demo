...
import com.example.demo.beans.limit.BusyFallbackResolver;
import com.example.demo.beans.limit.UserInfoInjecter;
...
public class DemoApplication {
	 ...
	 */
	@Bean
	LimiterFallbackResolver<ResponseEntity> busyFallback(){
